...
<div class="container">
    <div class="jumbotron">
        <h1 style="font-size: 45px; text-align: center;">Welcome to Admin Tours and Locations Dashboard</h1>
        <p style="text-align: center;">As an admin you can create tours, modify tours, remove tours, create locations, modify and remove locations.</p>
    </div>
